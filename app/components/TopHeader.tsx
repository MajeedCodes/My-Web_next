...
export default function TopHeader() {
  return (
    <>
      <div className="flex items-center justify-between border-b px-[70px] py-3">
        ...
        <div className="flex items-center gap-6">
          <Link href="/wishlist" className="text-sm hover:text-gray-600 hidden sm:block">
            My Wishlist
          </Link>
          <Link href="/track-order" className="text-sm hover:text-gray-600 hidden sm:block">
            Track Your Order
          </Link>
          <div className="flex gap-4">
            ...
            <Link href="https://youtube.com" className="hover:text-gray-600">

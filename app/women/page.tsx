...
export default function TrendingSection() {
  const [activeCategory, setActiveCategory] = useState<string>("Women"); // Default category set to "Women"
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      ...
      // Filter products based on the active category (default is "Women")
